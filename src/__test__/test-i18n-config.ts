...
const resources = {
    en: {
        translation: {
            ...
            // Vehicles
            'pages.vehicle.vehicles.title': "Vehicle's list",
            'pages.vehicle.vehicles.subtitle': 'Here is the list of vehicles',
            'pages.vehicle.vehicles.addButton': 'Add vehicle',

            'pages.vehicle.vehicles.form.title': 'Vehicle Form',
            'pages.vehicle.vehicles.form.subtitle': "Fill in vehicle's details below.",
            'pages.vehicle.vehicles.form.registration': 'Registration number',
            'pages.vehicle.vehicles.form.make': 'Make',
            'pages.vehicle.vehicles.form.model': 'Model',
            'pages.vehicle.vehicles.form.year': 'Year',
            'pages.vehicle.vehicles.form.vin': 'Vin',
            'pages.vehicle.vehicles.form.color': 'Color',
            'pages.vehicle.vehicles.form.mileage': 'Mileage',
            'pages.vehicle.vehicles.form.capacity': 'Capacity',
            'pages.vehicle.vehicles.form.insurancePolicyNum': 'Insurance policy number',
            'pages.vehicle.vehicles.form.notes': 'Notes',
            'pages.vehicle.vehicles.form.purchaseDate': 'Purchase Date',
            'pages.vehicle.vehicles.form.lastServiceDate': 'Last Service Date',
            'pages.vehicle.vehicles.form.nextServiceDue': 'Next Service Due',
            'pages.vehicle.vehicles.form.insuranceExpiryDate': 'Insurance Expiry Date',
            'pages.vehicle.vehicles.form.licenseExpiryDate': 'License Expiry Date',

            'pages.vehicle.vehicles.form.type.title': 'Vehicle Type',
            'pages.vehicle.vehicles.form.type.types.CAR': 'Car',
            'pages.vehicle.vehicles.form.type.types.MOTORCYCLE': 'Motorcycle',
            'pages.vehicle.vehicles.form.type.types.TRUCK': 'Truck',
            'pages.vehicle.vehicles.form.type.types.VAN': 'Van',

            'pages.vehicle.vehicles.form.status.title': 'Vehicle Status',
            'pages.vehicle.vehicles.form.status.statuses.ACTIVE': 'Active',
            'pages.vehicle.vehicles.form.status.statuses.IN_MAINTENANCE': 'In maintenance',
            'pages.vehicle.vehicles.form.status.statuses.OUT_OF_SERVICE': 'Out of service',

            'pages.vehicle.vehicles.form.fuel.title': 'Fuel type',
            'pages.vehicle.vehicles.form.fuel.types.GASOLINE': 'Gasoline',
            'pages.vehicle.vehicles.form.fuel.types.DIESEL': 'Diesel',
            'pages.vehicle.vehicles.form.fuel.types.ELECTRIC': 'Electric',
            'pages.vehicle.vehicles.form.fuel.types.HYBRID': 'Hybrid',

            'pages.vehicle.vehicles.card.name': 'Vehicle name',
            'pages.vehicle.vehicles.card.purchaseDate': 'Purchase date',
            'pages.vehicle.vehicles.card.capacity': 'Capacity',
            'pages.vehicle.vehicles.card.mileage': 'Mileage',
            'pages.vehicle.vehicles.card.nextServiceDue': 'Next service due',
            'pages.vehicle.vehicles.card.status': 'status',
            'pages.vehicle.vehicles.card.maintenance': 'Maintenance',
